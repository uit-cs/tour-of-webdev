	...
	return (
		<div>
			...
			<div
				...
				} fixed bg-gray sm:w-[400px] w-[50vw] top-0 right-0 z-50 rounded-l-md border-gray border-l-[1px] transition ease-in duration-200`}>
				<div className='flex flex-col h-[100vh] overflow-y-auto'>
					<div className='flex justify-between items-center bg-gray px-4 py-4 h-[48px] border-gray border-b-[1px] rounded-t-md'>
						<h1 className='sm:text-xl text-base'>Table of contents</h1>
						<XMarkIcon
